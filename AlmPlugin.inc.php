...
DEFINE('ALM_API_URL', 'http://pkp-alm.lib.sfu.ca/api/v5/articles/');
...
class AlmPlugin extends GenericPlugin {
	...
	function register($category, $path) {
		...
		if ($success && $context) {
			...
			HookRegistry::register('Templates::Article::Footer::PageFooter',array(&$this, 'articleMoreInfoCallback'));
